...
var ColorTracker = _interopDefault(require('canvas-color-tracker'));
var d3Force3d = require('d3-force-3d');
var Bezier = _interopDefault(require('bezier-js'));
...
var forceGraph = Kapsule({
  ...
  methods: _objectSpread2({
    ...
    getGraphBbox: function getGraphBbox(state) {
      ...
      var nodesPos = state.graphData.nodes.map(function (node) {
        return {
          x: node.x,
          y: node.y,
          r: getR(node)
